...
const prerendered = `<main class="beta-page beta-prerender">
  <article>
    ...
    <h2>Current Beta Tree vs Archived Demo Snapshot</h2>
    <p>Added: ${archiveDiff.added.length} · Removed: ${archiveDiff.removed.length} · Changed: ${archiveDiff.changed.length} · Unchanged: ${archiveDiff.unchanged.length}</p>
