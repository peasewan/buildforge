...
export function createExpansionClass(profile: ExpansionProfile, dataset: Dataset): ClassDefinition {
  ...
  const add = (input: {
    ...
    relatedBuildIds?: string[]; sections: ClassPageDefinition['sections']; comparison?: ClassPageDefinition['comparison']; updatedAt?: string
  }) => {
