  ...
  return (
    <main className="spec-talents-page">
      ...
      <section className="spec-tree-section shell" id="talent-tree">
        <header className="hub-section-heading"><div className="eyebrow">Beta Talent Data</div><h2>{page.title.replace('WoW Forever ', '')} Beta Talent Tree</h2><p>This example highlights a complete {page.allocation.value} route using Beta client build 1.60.1.69893. Open the calculator to remove ranks, compare another path, or share a custom setup.</p></header>
