...
export default function PaladinBuildsHub() {
  return (
    <main className="hub-page">
      ...
      <section className="hub-data shell"><div><div className="eyebrow">About Our Data</div><h2>Transparent Beta Data</h2></div><div><p>BuildForgeTools uses WoW Forever Beta client build 1.60.1.69913 for Paladin talent positions, ranks, prerequisite links, and tooltips. Because the client does not state how many prerequisite ranks are required, the planner currently applies the Classic max-rank rule and labels it as an assumption.</p><p>Build recommendations remain community planning references and may change as players test the Beta. The underlying talent data and its sources are reviewed separately.</p><a href={HUB_TALENTS.href}>{HUB_TALENTS.label} <ArrowRight size={15} /></a><br /><HubLink href="/wow-forever-paladin-abilities" placement="spellbook">Browse 45 Paladin abilities <ArrowRight size={15} /></HubLink><br /><HubLink href="/wow-forever-paladin-beta-talent-changes" placement="beta-tracker">Review Paladin Beta talent changes <ArrowRight size={15} /></HubLink></div></section>

      <SiteFooter links={[{ href: '/paladin', label: 'Talent Calculator' }, { href: '/wow-forever-paladin-talents', label: 'Paladin Talents' }, { href: '/wow-forever-paladin-abilities', label: 'Paladin Abilities' }, { href: '/wow-forever-protection-paladin-build', label: 'Protection Build' }]} />
    </main>
  )
}
