  ...
  return (
    <main className="protection-talents-page">
      <header className="guide-nav shell">
        ...
        <a className="button primary" href="/paladin#calculator" onClick={() => track('protection_talents_cta_click', { placement: 'header' })}>Open Planner</a>
      </header>
      ...
      <section className="protection-talents-hero">
        <div className="shell">
          ...
          <a className="button primary" href="/paladin#calculator" onClick={() => track('protection_talents_cta_click', { placement: 'hero' })}><Calculator size={17} /> Build This Setup</a>
        </div>
      </section>
      ...
      <section className="protection-tree-section shell" id="talent-tree">
        ...
        <div className="protection-tree-layout">
          ...
          <aside>
            ...
            <a className="button primary" href="/paladin#calculator" onClick={() => track('protection_talents_cta_click', { placement: 'tree' })}>Open Talent Calculator <ArrowRight size={15} /></a>
          </aside>
        </div>
      </section>
      ...
      <section className="protection-talent-final shell"><img src="/images/icons/shield.png" alt="" /><div><span>Ready to plan?</span><h2>Create Your Protection Build</h2></div><a className="button primary" href="/paladin#calculator" onClick={() => track('protection_talents_cta_click', { placement: 'footer' })}>Build this setup <ArrowRight size={15} /></a></section>
